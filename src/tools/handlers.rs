...
impl WebSearchHandler {
    ...
    #[tool(
        name = "web_search",
        description = "Search the web using one or more engines. engines parameter accepts an array: [\"bing\", \"duckduckgo\", ...]. Supported: bing, duckduckgo, brave, baidu, csdn, juejin, exa, zhihu, linuxdo."
    )]
